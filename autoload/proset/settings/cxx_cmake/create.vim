...
function s:get_cmakelists_content(project_name,
\           source_directory,
\           source_extension,
\           project_type)
...
function! proset#settings#cxx_cmake#create#create_main_file(source_directory_path,
\           source_extension)
